...
namespace Juice_Shop_Billing_System
{
    public partial class Add_juice_price : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DialogResult res = MessageBox.Show("Do you Add New Juice ", "Added juice", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
        ...
        { // update
            ...
            cmd.Parameters.AddWithValue("@p2", textBox2.Text);
            cmd.Parameters.AddWithValue("@p3", textBox3.Text);
            DialogResult res = MessageBox.Show("Do you Update Juice  ", "Updated juice", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
            if (res == DialogResult.Yes)
            {
                cmd.ExecuteNonQuery();
            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            cmd.Parameters.AddWithValue("@p1", textBox1.Text);           
            DialogResult res = MessageBox.Show("Do you Delete Juice  ", "Deleted juice", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question);
            if (res == DialogResult.Yes)
            {
                cmd.ExecuteNonQuery();
            }
